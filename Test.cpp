...
TEST_CASE("Good Notebook"){
    ...
    a.write(0,1,0,Direction::Vertical,"i'm writing vertical"); 
    CHECK(a.read(0,0,0,Direction::Vertical,22) == "_i'm writing vertical_");
...
TEST_CASE("writing on a writen or deleaten place is illegal"){
    Notebook a;
    CHECK(a.read(1,0,0,Direction::Horizontal,22) == "______________________");
    a.write(1,0,0,Direction::Horizontal,"first line of notebook"); 
    CHECK_THROWS(a.write(1,0,10, Direction::Vertical , "checking"));
    CHECK_THROWS(a.write(1,0,3, Direction::Vertical , "checking"));
    CHECK_THROWS(a.write(1,0,6, Direction::Vertical , "checking"));
    CHECK_THROWS(a.write(1,0,2, Direction::Vertical , "checking"));
    CHECK_THROWS(a.write(1,0,0, Direction::Vertical , "checking"));
    CHECK_THROWS(a.write(1,0,8, Direction::Vertical , "checking"));
    a.write(1,4,0,Direction::Horizontal,"second line of notebook"); 
    CHECK_THROWS(a.write(1,3,0, Direction::Vertical , "aba"));
    CHECK_THROWS(a.write(1,3,10, Direction::Vertical , "aba"));
    CHECK_THROWS(a.write(1,3,4, Direction::Vertical , "aba"));
    CHECK_THROWS(a.write(1,3,6, Direction::Vertical , "aba"));
    CHECK_THROWS(a.write(1,3,5, Direction::Vertical , "aba"));

}
TEST_CASE("(page || column || string || row) not valid"){
    Notebook a;
